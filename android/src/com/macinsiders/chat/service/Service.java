...
import com.macinsiders.chat.processor.ProcessorFactory;
import com.macinsiders.chat.processor.ResourceProcessor;
import com.macinsiders.chat.processor.ResourceProcessorCallback;
...
public class Service extends IntentService implements ServiceContract {
    ...
    protected void onHandleIntent(Intent requestIntent) {
        ...
        if (method.equalsIgnoreCase(METHOD_GET)) {
            ...
            processor.deleteResource(processorCallback, params);
